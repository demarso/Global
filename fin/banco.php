...
<body>
 ...
 <div id="interface">
  <? 
   ...
   $horacad2 = date('H:i');
 ?>
 <form name="form1" method="post" action="bancoOK.php" >
  
   <H1>CADASTRO DE BANCO</H1>
   <div id="caixa1">
     <table>
        <H2>&nbsp;&nbsp;&nbsp;&nbsp;Insira os dados do Banco</H2>
      <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
          <td><h3>Número:</h3></td>
           <td>
             <input type="text" name="numero" id="numero" size="10" tabindex="1" required="true">
           </td>
      </tr>
      <tr>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
          <td><h3>Nome:</h3></td>
           <td>
             <input type="text" name="nome" id="nome" size="40" tabindex="2" style='text-transform:uppercase' required="true">
           </td>
      </tr>
      <tr>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
          <td><h3>Agência:</h3></td>
           <td>
             <input type="text" name="agencia" id="agencia" size="30" tabindex="3" required="true">
           </td>
      </tr>
      <tr>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
          <td><h3>Conta:</h3></td>
           <td>
             <input type="text" name="conta" id="conta" size="30" tabindex="3" required="true">
           </td>
      </tr>
     </table>
    <center><br />
