 ...
 <form name="form1" method="post" action="usuarioOK.php" >
   ...
   <table>
    ...
    <tr>
        <td><h3>Empresa:</h3></td>
         <td>
          <select name="empresa" id="empresa"  tabindex="5" required="true">
            <option value=""> - - -</option>
    ...
    <tr>
         ...
         <td>
          ...
          </select><b>&nbsp;&nbsp;(0)Financeiro&nbsp;&nbsp;&nbsp;&nbsp;(1)Fiscal&nbsp;&nbsp;&nbsp;&nbsp;(2)Caixa&nbsp;&nbsp;&nbsp;&nbsp;(3)Baixa</b>
         </td>
    </tr>
    <tr>
         <td><h3>Status:</h3></td>
         <td>
             <INPUT TYPE="RADIO" NAME="status" VALUE="Ativo" tabindex="7"> Ativo
