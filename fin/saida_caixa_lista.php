...
?>
   <br />
	 <h1>Sa&iacute;das do Caixa de <? echo date('d/m/Y',strtotime($data1))." a ".date('d/m/Y',strtotime($data2)) ?><br /></h1>
...
<!--  <th align="center" style="width: 5%"></th>-->
	...
	<?php
  	...
  	$sql = "SELECT *, DATE_FORMAT(data,'%d/%m/%Y') as dat FROM caixasaida WHERE data >= '$data1' AND data <='$data2' ORDER BY data desc";
  ...
  $sql2 = "SELECT *, DATE_FORMAT(dataCaixa,'%d/%m/%Y') as dati FROM sangria WHERE dataCaixa >= '$data1' AND dataCaixa <='$data2' ORDER BY dataCaixa desc";
