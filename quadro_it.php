...
include "conexao.php";
  /*        
     ...
     if($nomer == "ITAGUAÍ"){
      ...
      $sql0 = "SELECT idEquipe, nome, status FROM equipe WHERE regional = 'ITAGUAÍ' AND status = 'Ativo'";
...
<br /><br />
 <center>
  <H2><font color="blue"><b>EQUIPE <? echo $nomee;  ?></b></font> - REGIONAL ITAGUAÍ</H2>
...
$_SESSION['reatit'] = $_SESSION['reatit'] + $reattot;
$_SESSION['subit'] = $_SESSION['subit'] + $subtot;
$_SESSION['totalit'] =  $_SESSION['totalit'] + $normaltot;
