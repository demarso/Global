...
$_SESSION['total'] = $_SESSION['total'] + $tot;
?>
<center>
  <table align="center" width="80%"  border="1">
   <tr align="center" <? echo $bgcolor; ?>>
...
<a href="imp_quadro.php?eqp=<? echo $nomee ?>"><img src="imagens/Logo_Excel-pt.png" width="60" align="right" title="Exporta quadro <? echo $nomee ?> para arquivo EXCEL"></a>
<?  $tot =0; } } }?>