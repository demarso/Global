...
$arqexcel = "</b>QUADRO DA PRODU&Ccedil;&Atilde;O DA EQUIPE OS INCRIVEIS DE ".$mesatual."</b>";
...
if($equipe1 == "OS INCRÍVEIS" || $equipe1 == "OS INCRIVEIS"){
...
$arqexcel .= "<table align='center' width='80%'  border='1'>
   <tr align='center'>
    <td  align='center' style='width: 20%'><font size='2'><b>PRODU&Ccedil;&Atilde;O</b></font></td>
   ...
   header("Content-Disposition:attachment; filename = quadro_incriveis.xls");
   echo $arqexcel;
?>
