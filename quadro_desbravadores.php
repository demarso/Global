...
include "conexao.php";
      ...
      while ( $row0 = mysqli_fetch_array($results0) ){
              ...
              $nom = $row0['nome'];
              $sta = $row0['status'];
        if($nom == 'DESBRAVADORES') { 
?>
<br /><br />
 <center>
 <H2>EQUIPE DESBRAVADORES</H2>
...
<a href="imp_quadro_desbravadores.php?eq=<? echo $eq; ?>"><img src="imagens/Logo_Excel-pt.png" width="60" align="right" title="Exporta quadro Desbravadores para arquivo EXCEL"></a>
<?  $tot =0; } } ?>