...
include "conexao.php";
      ...
      while ( $row0 = mysqli_fetch_array($results0) ){
              ...
              $nom = $row0['nome'];
              $sta = $row0['status'];
        if($nom == "FALCAO" || $nom == "FALCÃO") { 
?>
<br /><br />
 <center>
 <H2>EQUIPE FALC&Atilde;O</H2>
...
if($equipe1 == "FALCAO" || $equipe1 == "FALCÃO"){
   $eq = $equipe1;
...
<a href="imp_quadro_falcao.php?eq=<? echo $eq; ?>"><img src="imagens/Logo_Excel-pt.png" width="60" align="right" title="Exporta quadro FALCÃO para arquivo EXCEL"></a>
<?  $tot =0; } } ?>