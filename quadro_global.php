...
include "conexao.php";
    ...
    $sql1 = "SELECT * FROM consultor WHERE equipe = '$eq' ORDER BY nome";
...
$con = $con + 1; $normaltot = $normaltot + $normal; $reattot = $reattot + $reat; $subtot = $subtot + $sub;
   ...
   // }
$con = $con - 1;
$_SESSION['reatglobal'] = $_SESSION['reatglobal'] + $reattot;
$_SESSION['subglobal'] = $_SESSION['subglobal'] + $subtot;
$_SESSION['totglobal'] = $_SESSION['totglobal'] + $normaltot;
