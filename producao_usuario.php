...
<body>
 ...
 <thead>
  <tr align="center" bgcolor="#CCCCCC">
    ...
    <th align="center" style="width: 5%"><font color="#333333" size="3"><b>Data Cad</b></font></th>
    <th align="center" style="width: 5%"><font color="#333333" size="3"><b>Receb.</b></font></th>
    <th align="center" style="width: 21%"><font color="#333333" size="3"><b>Usuario</b></font></th>
...
$saldo = 0;  $con = 1; $totsub = 0;
//echo $dia." / ".$mes." / ".$ano;

$sql = "SELECT *, DATE_FORMAT(dataProposta,'%d/%m/%Y') as idataProposta, DATE_FORMAT(dataRecebimento,'%d/%m/%Y') as idataRecebimento, DATE_FORMAT(dataInstalacao,'%d/%m/%Y') as idataInstalacao, DATE_FORMAT(datacadA,'%d/%m/%Y') as idataCad FROM producao WHERE MONTH(dataProposta) = '$mes' AND YEAR(dataProposta) = '$ano' ORDER BY datacadA DESC";
...
<table id="tabela" align="center" width="100%"  border="1">
 <tbody>
  <tr align="center" <? echo $bgcolor; ?>>
    ...
    <td align="center" style="width: 5%"><font <? echo $nomecolor; ?> size="2"><b><? echo $dataCad; ?></b></font></td>
    <td align="center" style="width: 5%"><font <? echo $nomecolor; ?> size="2"><b><? echo $dataRecebimento; ?></b></font></td>
    
    <td align="center" style="width: 21%"><font <? echo $nomecolor; ?> size="2"><b><? echo $usuarioCad; ?></b></font></td>
