           ...
           <tr>
    		...
    		<tr>
	         <td><h3>Pagamento:</h3></td>
  	         <td>
              <INPUT TYPE="RADIO" NAME="boleto" VALUE="Dinheiro" tabindex="2"> Dinheiro
              <INPUT TYPE="RADIO" NAME="boleto" VALUE="Débito"> Débito
              <INPUT TYPE="RADIO" NAME="boleto" VALUE="Crédito"> Crédito
  	         </td>
        </tr>
        <tr>
	         <td><h3>Motivo:</h3></td>
    		...
    		<tr>
          	...
          	<tr>
		        <td><h3>Valor:</h3></td>
		         <td>
		          <input type="text" name="valor" size="10" onkeyup="maskIt(this,event,'###.###.###,##',true)" style="text-align: right;" >
		         </td>
    		</tr>
          </table>
         <center>
   ...
   <center>
    <?
     ...
     include "conexao.php";
      ...
      echo "<br />";  
      echo "Saídas: <font color='red'>R$ ".$saidas2."</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Saldo em dinheiro: <font $cor>R$ ".$saldo2."</font>";
    }
    ?>
  </center>
 </div>
