...
include "conexao.php";
      ...
      while ( $row0 = mysqli_fetch_array($results0) ){
              ...
              $nom = $row0['nome'];
              $sta = $row0['status'];
        if($nom == "JACAREPAGUÁ" || $equipe1 == "JACAREPAGUA") { 
?>
<br /><br />
 <center>
 <H2>EQUIPE JACAREPAGUÁ</H2>
...
if($equipe1 == "JACAREPAGUÁ" || $equipe1 == "JACAREPAGUA"){
   $eq = $equipe1;
...
$sql2 = "SELECT substituicao FROM producao WHERE idConsultor='$id3' AND MONTH(dataProposta) = '$mes' AND status = 'Ativo'";
...
<a href="imp_quadro_jacarepagua.php?eq=<? echo $eq; ?>"><img src="imagens/Logo_Excel-pt.png" width="60" align="right" title="Exporta quadro JACAREPAGUÁ para arquivo EXCEL"></a>
<?  $tot =0; } } ?>