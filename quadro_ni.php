 ...
 // $mes = date("m");
  ...
  /*
    if($mes == $mes_atual && $ano == $ano_atual){
      ...
      $sql0 = "SELECT idEquipe, nome, status FROM equipe WHERE regional = 'NOVA IGUAÇU'";
  */
    $sql0 = "SELECT idEquipe, nome, status FROM equipe WHERE regional = 'NOVA IGUAÇU' AND status = 'Ativo'";
...
?>
  <br /><br />
  <center>
  <H2><font color="blue"><b>EQUIPE <? echo $nomee;  ?></b></font> - REGIONAL NOVA IGUAÇU</H2>
...
<?
  $con = $con + 1; $normaltot = $normaltot + $normal; $reattot = $reattot + $reat; $subtot = $subtot + $sub;
    ...
    } $consu = $id; $tot = $tot + $normal; $normal = 0; $totalg = $tot + $reattot + $subtot; $cons0 = $id2;
      }
  
  $con = $con - 1;
  $saldo = number_format(round($saldo * 2 )/ 2,2);
  $_SESSION['reatni'] = $_SESSION['reatni'] + $reattot;
  $_SESSION['subni'] = $_SESSION['subni'] + $subtot;
  $_SESSION['totalni'] = $_SESSION['totalni'] + $normaltot;
...
?>
  ...
  <a href="imp_quadro_<? echo $nomee ?>.php?eq=<? echo $nomee; ?>&mes=<? echo $mes; ?>&ano=<? echo $ano; ?>"><img src="imagens/Logo_Excel-pt.png" width="60" align="right" title="Exporta quadro <? echo $nomee ?> para arquivo EXCEL"></a>
<?   
$tot =0;
$normaltot = 0;
$reattot = 0;
