...
include "conexao.php";
    /*      
     ...
     // if($mes == $mes_atual)
        $sql0 = "SELECT idEquipe, nome, status FROM equipe WHERE regional = 'INTENDENTE' AND status = 'Ativo'";
     // else if($mes <> $mes_atual)
     //   $sql0 = "SELECT idEquipe, nome, status FROM equipe WHERE regional = 'INTENDENTE'";
...
<br /><br />
 <center>
  <H2><font color="blue"><b>EQUIPE <? echo $nomee;  ?></b></font> - REGIONAL INTENDENTE</H2>
...
$_SESSION['totalin'] = $_SESSION['totalin'] + $tot;
