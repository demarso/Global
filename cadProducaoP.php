...
<script type="text/javascript">
       ...
       /* $(document).ready(function(){
        ...
        $(document).ready(function() {
         $(function ()  
         {
             $("#idc").popover({title: 'Código do Cunsultor', trigger: 'hover', content: "Este é o código do consultor para ser usado na proposta!"});  
         });  
        });*/
   ...
   <table>
    ...
    <tr>
        <td><h3>Consultor:</h3>
         ...
         <td>
          <select name="consultor" id="consultor" tabindex="1" required="true" onchange="ajaxGet('processConsultaId.php?Nome='+this.value,document.getElementById('idc'),true);">
            <option value="">---</option>
              <?php
                include ("conexao.php");
                $sql = "SELECT nome FROM consultor WHERE status='Ativo' AND regional='$regi' || status='Ativo' AND $_SESSION[nivel] = 0 || status='Ativo' AND $_SESSION[nivel] = 10 ORDER BY nome";
         ...
         </td><td>&nbsp;&nbsp;<b><imput name="idc" id="idc" size="3" style="text-align:right; color:blue;" readonly="true" data-toggle="popover" data-trigger="hover" data-placement="left" data-content="Este é o código do consultor para ser usado na proposta!" /></b></td>
      </tr>
<!--  <tr><td align="left">
          <? /*
  ...
  <div id="palco6"> 
   <table>
    ...
    <tr>
         ...
         <td>
             <INPUT TYPE="RADIO" NAME="rastrea" VALUE="Sim" tabindex="6"> Sim
