...
<body>
 ...
 <div class="form-group col-md-12 text-right">
   <input class="input-group input-group-lg" id="myInput" type="text" placeholder="Digite aqui a sua busca...">
</div>
<center>
...
$sql = "SELECT *, DATE_FORMAT(dataProposta,'%d/%m/%Y') as idataProposta, DATE_FORMAT(dataRecebimento,'%d/%m/%Y') as idataRecebimento, DATE_FORMAT(dataInstalacao,'%d/%m/%Y') as idataInstalacao FROM producao WHERE MONTH(dataProposta) = '$mes' AND YEAR(dataProposta) = '$ano' AND status = 'Ativo' ORDER BY dataProposta DESC";
