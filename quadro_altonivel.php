...
include "conexao.php";
      ...
      while ( $row0 = mysqli_fetch_array($results0) ){
              ...
              $nom = $row0['nome'];
              $sta = $row0['status'];
        if($nom == "ALTO NIVEL" || $nom == "ALTO NÍVEL") { 
?>
<br /><br />
 <center>
 <H2>EQUIPE ALTO NÍVEL</H2>
...
if($equipe1 == "ALTO NIVEL" || $equipe1 == "ALTO NÍVEL"){
   $eq = $equipe1;
...
<a href="imp_quadro_altonivel.php?eq=<? echo $eq; ?>"><img src="imagens/Logo_Excel-pt.png" width="60" align="right" title="Exporta quadro Fenix para arquivo EXCEL"></a>
<?  $tot =0; } } ?>