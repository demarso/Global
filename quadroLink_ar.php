...
include "conexao.php";
      ...
      $sql0 = "SELECT idEquipe, nome, status FROM equipe WHERE regional = 'ARARUAMA' AND status = 'Ativo'";
...
$sql1 = "SELECT * FROM consultor WHERE regional = 'ARARUAMA' AND status = 'Ativo' ORDER BY nome";
...
$_SESSION['totalar'] = $_SESSION['totalar'] + $tot;
?>
<center>
  <table align="center" width="80%"  border="1">
   <tr align="center" <? echo $bgcolor; ?>>
